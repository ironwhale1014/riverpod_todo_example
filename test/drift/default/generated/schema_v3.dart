...
class TodoEntriesFts extends Table
    with
        TableInfo<TodoEntriesFts, TodoEntriesFtsData>,
        VirtualTableInfo<TodoEntriesFts, TodoEntriesFtsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  TodoEntriesFtsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TodoEntriesFtsData(
      description: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}description'],
      )!,
...
class TodoEntriesFtsData extends DataClass
    implements Insertable<TodoEntriesFtsData> {
  final String description;
  const TodoEntriesFtsData({required this.description});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['description'] = Variable<String>(description);
  ...
  factory TodoEntriesFtsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TodoEntriesFtsData copyWith({String? description}) =>
      TodoEntriesFtsData(description: description ?? this.description);
  TodoEntriesFtsData copyWithCompanion(TodoEntriesFtsCompanion data) {
    return TodoEntriesFtsData(
      description: data.description.present
          ? data.description.value
          : this.description,
  ...
  @override
  String toString() {
    return (StringBuffer('TodoEntriesFtsData(')
          ..write('description: $description')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TodoEntriesFtsData && other.description == this.description);
}

class TodoEntriesFtsCompanion extends UpdateCompanion<TodoEntriesFtsData> {
  final Value<String> description;
  ...
  static Insertable<TodoEntriesFtsData> custom({
    Expression<String>? description,
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final Trigger todoEntriesInsert = Trigger(
    'CREATE TRIGGER todo_entries_insert AFTER INSERT ON todo_entries BEGIN INSERT INTO todo_entries_fts ("rowid", description) VALUES (new.id, new.description);END',
    'todo_entries_insert',
  );
  late final Trigger todoEntriesUpdate = Trigger(
    'CREATE TRIGGER todo_entries_update AFTER UPDATE ON todo_entries BEGIN INSERT INTO todo_entries_fts (todo_entries_fts, "rowid", description) VALUES (\'delete\', old.id, old.description);INSERT INTO todo_entries_fts ("rowid", description) VALUES (new.id, new.description);END',
    'todo_entries_update',
  );
  late final Trigger todoEntriesDelete = Trigger(
    'CREATE TRIGGER todo_entries_delete AFTER DELETE ON todo_entries BEGIN INSERT INTO todo_entries_fts (todo_entries_fts, "rowid", description) VALUES (\'delete\', old.id, old.description);END',
    'todo_entries_delete',
  );
  @override
