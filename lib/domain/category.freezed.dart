...
mixin _$Category {
 ...
 int get id; String get name;@ColorConverter() Color get color;
...
@useResult
$Res call({
 int id, String name,@ColorConverter() Color color
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @ColorConverter()  Color color)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Category() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @ColorConverter()  Color color)  $default,) {final _that = this;
switch (_that) {
case _Category():
return $default(_that.id,_that.name,_that.color);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @ColorConverter()  Color color)?  $default,) {final _that = this;
switch (_that) {
case _Category() when $default != null:
return $default(_that.id,_that.name,_that.color);case _:
  return null;
...
class _Category implements Category {
  const _Category({required this.id, required this.name, @ColorConverter() required this.color});
