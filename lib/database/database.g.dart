...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  Selectable<GetCategoryWithCountResult> getCategoryWithCount() {
    return customSelect(
      'SELECT c.*, (SELECT COUNT(*) FROM todo_entries AS te WHERE te.category = c.id) AS amount FROM categories AS c UNION ALL SELECT NULL, NULL, NULL, (SELECT COUNT(*) FROM todo_entries AS te WHERE te.category IS NULL)',
      variables: [],
